...
function NodeProperties({ node, onUpdate, onDelete }) {
    ...
    return (_jsxs("div", { style: { padding: 12 }, children: [_jsxs("div", { style: {
                    ...
                    alignItems: "center",
                    marginBottom: 8,
                }, children: [_jsxs("div", { children: [_jsx(Title, { level: 5, style: { margin: 0, fontSize: 14 }, children: schema.label }), isContainer && (_jsx(Tag, { color: "orange", style: { marginTop: 4, fontSize: 10 }, children: "\u5BB9\u5668\u8282\u70B9" }))] }), _jsx(Button, { danger: true, size: "small", type: "text", icon: _jsx(DeleteOutlined, {}), onClick: onDelete })] }), _jsx(Text, { type: "secondary", style: { fontSize: 11, display: "block", marginBottom: 12 }, children: schema.description }), _jsx(Divider, { style: { margin: "8px 0" } }), _jsxs(Form, { layout: "vertical", size: "small", children: [schema.fields.map((field) => (_jsx(Form.Item, { label: _jsx("span", { style: { fontSize: 12 }, children: field.label }), required: field.required, style: { marginBottom: 10 }, children: _jsx(FieldRenderer, { field: field, value: data.fields[field.name], onChange: (val) => handleFieldChange(field.name, val) }) }, field.name))), _jsx(Form.Item, { label: _jsx("span", { style: { fontSize: 12 }, children: "\u6B65\u9AA4\u8BF4\u660E" }), style: { marginBottom: 0 }, children: _jsx(Input.TextArea, { size: "small", rows: 2, placeholder: "\u53EF\u9009\uFF1A\u63CF\u8FF0\u8FD9\u4E2A\u6B65\u9AA4", defaultValue: data.description || "", onChange: (e) => handleDescriptionChange(e.target.value) }) })] }), _jsxs("div", { style: { marginTop: 12, fontSize: 10, color: "#bfbfbf" }, children: ["ID: ", node.id] })] }));
}
