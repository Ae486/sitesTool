...
class ProxyHealthCheckerTest {
    ...
    void checkAll_noActiveProxies_doesNothing() {
        ...
        verify(proxyPoolService, never()).updateScore(anyLong(), anyBoolean(), anyInt());
    }
    ...
    void checkAll_logsHealthCheckResult() {
        ...
        doNothing().when(proxyPoolService).updateScore(anyLong(), anyBoolean(), anyInt());
    ...
    void checkAll_updatesScoreAfterCheck() {
        ...
        verify(proxyPoolService).updateScore(eq(Long.valueOf(5L)), eq(false), anyInt());
    }
    ...
    void checkAll_multipleProxies_checksAll() {
        ...
        verify(proxyPoolService).updateScore(eq(Long.valueOf(1L)), anyBoolean(), anyInt());
        verify(proxyPoolService).updateScore(eq(Long.valueOf(2L)), anyBoolean(), anyInt());
    }
    ...
    void checkAll_updateScoreThrows_doesNotPropagateException() {
        ...
        doThrow(new RuntimeException("DB down")).when(proxyPoolService)
                .updateScore(anyLong(), anyBoolean(), anyInt());
